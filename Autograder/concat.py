...
def illegalSyntax(data:str, text:str, bareMode:bool):
    ...
    for line in text.split('\n'):
        ...
        if illegalSyscalls(linelow, 12): errors.writelines("using syscall 12 \"read char\" may cause issues with autograder. please change it to read string and set the Maximum number of characters to 4 -> %s\n"%line)
